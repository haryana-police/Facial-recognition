...
/**
 * FidelitySlider — Mobile-friendly
 * Large slider thumb, readable labels, collapsible info box on mobile.
 */
    ...
    <div className="glass-card p-4 sm:p-5 space-y-4">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-0.5 shrink-0">
          <span className="font-mono text-xl sm:text-2xl font-bold text-forensic-400">
            {value.toFixed(2)}
          </span>
      ...
      {/* Slider — large touch target on mobile */}
      <div className="space-y-2">
        <input
          ...
          className="w-full h-2 accent-forensic-500 cursor-pointer"
          aria-label="CodeFormer fidelity weight"
          style={{ WebkitAppearance: 'none' }}
        />
        {/* Scale labels */}
        <div className="flex justify-between text-[10px] sm:text-xs text-white/30">
      ...
      <div className="flex items-start gap-2 rounded-xl bg-forensic-500/5 border border-forensic-500/10 p-3">
        ...
        <p className="text-xs text-white/50 leading-relaxed">
          ...
          Values ≥ 0.80 prevent AI hallucination of facial features.
        </p>
      </div>
    </div>
  )
