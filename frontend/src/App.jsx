...
export default function App() {
  ...
  // Pre-search filters
  const [filters, setFilters] = useState({ gender: '', age: '', height_cm: '' })
  ...
  const activeFilterCount = [filters.gender, filters.age, filters.height_cm].filter(Boolean).length
    ...
    <div className="min-h-screen bg-surface-950 text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 rounded-xl bg-white/5 p-1">
              <button
                ...
                className={`flex items-center gap-2 rounded-lg px-4 py-1.5 text-xs font-semibold transition-all duration-200
                  ${activeTab === 'search'
      ...
      <div className="mx-auto max-w-6xl px-4 pt-8 pb-2 sm:px-6">
        ...
        <p className="mt-1 text-sm text-white/40">
          {activeTab === 'search'
            ? 'Filters lagao, CCTV frame upload karo, aur suspect database se match karo.'
              ...
              <div className="glass-card flex min-h-[400px] flex-col items-center justify-center gap-4 p-8 text-center">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/20">
                    Set filters (optional) → Upload CCTV frame → Search
                  </p>
                </div>
              </div>
            )}
